...
<section class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <form method="post" action="/dashboard/edit/{{ $patient->id }}">
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label>No RM</label>
                    <input type="text" class="form-control" placeholder="Input No RM" name="medic_record" required value="{{ $patient->medic_record }}">
                  </div>
                  <div class="form-group">
                    <label>Nama Pasien</label>
                    <input type="text" class="form-control" placeholder="Input Nama Pasien" name="name" required value="{{ $patient->name }}">
                  </div>
                  <div class="form-group">
                    <label>No KTP</label>
