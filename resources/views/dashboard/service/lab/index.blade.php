            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" placeholder="Keterangan" name="#" required value="" >
                    </div>
            ...
            {{-- <div class="card-footer">
              <div class="float-right">
                <div class="alert alert-success">
                  <h4><i class="icon fas fa-file-invoice-dollar" aria-hidden="true"></i> Grand Total Rp.0</h4>
                </div>
              </div>
            </div> --}}
          </div>
